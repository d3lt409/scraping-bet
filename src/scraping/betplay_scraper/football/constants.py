...
XPATH_BUTTON_ALL_OFFERS = "//button[@class='KambiBC-outcomes-list__toggler-toggle-button']"

XPATH_RESULT_GAME = ".//div[@class='OutcomeButton__Wrapper-sc-lxwzc0-0 bJwiPp']"
